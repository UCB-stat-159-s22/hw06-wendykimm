...
def plot_figs(eventname, time, timemax, SNR, pcolor, det, tevent, strain_whitenbp, template_match, template_fft, datafreq, d_eff, freqs, data_psd, fs, plottype):
    ...
    plt.xlabel('Time since {0:.4f}'.format(timemax))
    plt.legend(loc='upper left')
    plt.savefig("figurs/eventname"+eventname+"_"+det+"_SNR."+plottype)
